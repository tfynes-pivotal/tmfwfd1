...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tfynes-pivotal&repo=tmfwfd1",
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=tmfwfd1","dbType":"h2","rabbitMQName":"rmq1","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"default","projectName":"where-for-dinner","workloadNamespace":"defai;t","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input14332952089167769771, --data-values-file, /tmp/accelerator-options14838110210456050509.json, --output-files, /tmp/ytt-output2407838107832623655]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tfynes-pivotal&repo=tmfwfd1'
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=tmfwfd1","dbType":"h2","rabbitMQName":"rmq1","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"default","projectName":"where-for-dinner","workloadNamespace":"defai;t","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input8739901677157857641, --data-values-file, /tmp/accelerator-options9240874871359429643.json, --output-files, /tmp/ytt-output11696390048567536930]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=tmfwfd1","dbType":"h2","rabbitMQName":"rmq1","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"default","projectName":"where-for-dinner","workloadNamespace":"defai;t","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17566502629746017947, --data-values-file, /tmp/accelerator-options3047203054554312593.json, --output-files, /tmp/ytt-output8205138172985685640]
